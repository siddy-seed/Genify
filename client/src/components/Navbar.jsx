                ...
                <div className='hidden md:flex items-center gap-8'>
                    <Link
                        ...
                        className={`text-sm font-medium transition-smooth ${location.pathname === '/'
                                ? 'text-gold-600'
                                : 'text-warmGray-700 hover:text-gold-600'
                            }`}
                    >
                        Generate
                    </Link>
                    <Link
                        to='/history'
                        className={`text-sm font-medium transition-smooth ${location.pathname === '/history'
                                ? 'text-gold-600'
                                : 'text-warmGray-700 hover:text-gold-600'
                            }`}
                    >
            ...
            <div>
                {
                    user ?
                        <div className='flex items-center gap-2 sm:gap-3'>
                            ...
                            <p className='text-gray-600 nax-sm:hidden pl-4'>Hi, {user.name}</p>
